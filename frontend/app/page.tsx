...
export default function Home() {
  return (
    <main className="relative overflow-hidden px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl flex-1">
        <section className="glass-panel relative flex min-h-[calc(100vh-4rem)] w-full flex-1 overflow-hidden rounded-[2rem] border border-white/70 px-6 py-10 shadow-float sm:px-10 sm:py-14 lg:px-14 lg:py-16">
